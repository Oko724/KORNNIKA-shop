    ...
    <header className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          ...
          >
            ค้นหาเสื้อผ้าที่เข้ากับสไตล์ของคุณ
          </motion.h2>
          <motion.p
          ...
          >
            เลือกชมเสื้อผ้าหลากสไตล์ที่ออกแบบอย่างพิถีพิถัน เพื่อสะท้อนความเป็นตัวคุณและตอบโจทย์ทุกสไตล์!
          </motion.p>
          <motion.div
            initial={{ y: "100px", opacity: 0 }}
            whileInView={{ y: "0", opacity: 1 }}
        ...
        <motion.section
          ...
          className="relative md:px-4 min-h-[448px] md:min-h-[428px] bg-cover lg:min-w-full bg-top xl:bg-[center_top_-1.6rem] bg-no-repeat bg-[url('/images/header-korn-all.png')]"
        >
          <Image
            priority
