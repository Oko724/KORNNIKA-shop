    ...
    <main className="pb-20">
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        {cart && cart.items.length > 0 ? (
              ...
              <div className="w-full lg:max-w-[505px] p-5 md:px-6 flex-col space-y-4 md:space-y-6 rounded-[20px] border border-black/10">
                ...
                <div className="flex flex-col space-y-5">
                  <div className="flex items-center justify-between">
                    <span className="md:text-xl text-black/60">ยอดรวม</span>
                  ...
                  <hr className="border-t-black/10" />
                  <div className="flex items-center justify-between">
                    <span className="md:text-xl text-black">ยอดรวมทั้งหมด</span>
                ...
                <div className="flex space-x-3">
                  <InputGroup className="bg-[#F0F0F0]">
                    ...
                    <InputGroup.Input
                      type="text"
                      name="code"
                      placeholder="เพิ่มโค้ดโปรโมชั่น"
          ...
          <div className="flex items-center flex-col text-gray-500 mt-32">
            <TbBasketExclamation strokeWidth={1} className="text-6xl" />
            <span className="block mb-4">ตะกร้าของคุณว่างเปล่า</span>
